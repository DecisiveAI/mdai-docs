...
**💪 Congratulations! You're about to provision an MDAI Nucleus! 💪**


<div class="warning">
  IMPORTANT! After deployment, the nucleus will be active and running in AWS. The current version of the nucleus was designed to be as cost-effective as possible, however you should still carefully monitor your spend and manage your nucleus capacity accordingly. If the nucleus is not actively being used for testing or managing telemetry pipelines, you may wish to shut it down to minimize your spend.<br /><br />
  <em>We hope to have benchmarks soon for cost and performance of our nucleuss.</em>
</div>

## Deploy the MDAI Nucleus
...
<div class="warning">
  ...
  <p>There's one more manual verification step required before CloudFormation will deploy all necessary infrastructure to get your nucleus up and running as soon as possible.</p>
</div>
...
<center>
  <h3>Want to see how the MDAI Nucleus runs locally?</h3>
  <p>
...
----
<span class="left"><a href="./apply-config.md">⏪ Back to: Configure Your Nucleus</a></span>
