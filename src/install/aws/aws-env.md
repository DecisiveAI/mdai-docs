...
These fields will assist you in identifying your cluster resources for internal and external use. 
...
| Key                       | READONLY Value       | Required | Description |
| :------------------------ | :------------------- | :------: |:----------  |
...
If you choose to remain opt'd-out ignore field `COGNITO` and `MDAI_UI_USER_POOL_DOMAIN`. 
