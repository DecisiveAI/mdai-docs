# The MyDecisive Nucleus Console

<!-- toc -->

## Introduction

The MyDecisive Nucleus console provides an at-a-glance display of all the telemetry data that has flowed through your MDAI Nucleus in the last hour. It is a web application accessible via HTTPS within the nucleus.
...
<img src="../media/console-data-flow.png" alt="The MDAI Nucleus Console showing data flows" style="width: 600px" />
</div>
...
<div style="text-align: center">
<img src="../media/console-pipelines.png" alt="The MDAI Nucleus Console showing pipeline configuration" style="width: 600px" />
</div>
...
<div style="text-align: center">
<img src="../media/console-viz-mode.png" alt="The MDAI Nucleus Console with pipelines mode switch highlighted" style="width: 600px" />
</div>
...
<div style="text-align: center">
<img src="../media/console-filters.png" alt="The MDAI Nucleus Console showing content filter options" style="width: 600px" />
</div>
